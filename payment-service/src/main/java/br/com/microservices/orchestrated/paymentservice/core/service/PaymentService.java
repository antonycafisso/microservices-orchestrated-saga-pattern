...
public class PaymentService {
    ...
    private static final Double MIN_AMOUNT_AVAILABLE = 0.1;
    ...
    private void validateAmount(Double amount) {
        if(amount < MIN_AMOUNT_AVAILABLE) {
            throw new ValidationException("The minimum amount available is ".concat(MIN_AMOUNT_AVAILABLE.toString()));
        }
    }
